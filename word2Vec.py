...
sim_1 = model.wv.similarity('胸痛', '心肌梗死')
sim_2 = model.wv.similarity('病理', '靶向治疗')
sim_3 = model.wv.similarity('病理', '肺腺癌')

print("\n" + "="*40)
print("Word2Vec核心医学词汇语义关联测试")
print("="*40)
print(f"'胸痛'与'心肌梗死'的余弦相似度: {sim_1:.4f}")
print(f"'病理'与'靶向治疗'的余弦相似度: {sim_2:.4f}")
print(f"病理'与'肺腺癌'的余弦相似度: {sim_3:.4f}")
print("="*40 + "\n")
